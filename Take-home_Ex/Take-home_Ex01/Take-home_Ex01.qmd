...
Let's build a logistic regression model to confirm and check our clinical implications from our visual plots.

## 7.1 Recoding Variables

### 7.1.1 Recoding Continuous Variables

Scale between 0 and 1 as they are on vastly different scales

```{r}
heartattack_lr <- heartattack %>%
  mutate(
    Cholesterol_Level = rescale(Cholesterol_Level, to = c(0, 1)),
    Stress_Levels = rescale(Stress_Levels, to = c(0, 1)),
...
1: Yes Heart Attack Occurrence

0: No Heart Attack Occurrence
